...
class Page(object):
    ...
    def addRedactAnnot(self, quad, text=None, fontname=None,
                       ...
                       stroke=(1, 0, 0), cross=True, width=1):
    ...
    #------------------------------------------------------------------
        ...
        stroke = " ".join(map(str, stroke)) + " RG"
        bstroke = stroke.encode("utf-8")
        ap_tab.append(bstroke)

        width = str(width) + " w"
        bwidth  = width.encode("utf-8")
        ap_tab.append(bwidth)
